...
public class RedirectionRule implements org.apache.thrift.TBase<RedirectionRule, RedirectionRule._Fields>, java.io.Serializable, Cloneable, Comparable<RedirectionRule> {
  ...
  private static final org.apache.thrift.protocol.TField INIT_REDIRECT_MAX_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("initRedirectMaxCount", org.apache.thrift.protocol.TType.I32, (short)5);
  private static final org.apache.thrift.protocol.TField SESSION_REDIRECT_MAX_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("sessionRedirectMaxCount", org.apache.thrift.protocol.TType.I32, (short)6);
  private static final org.apache.thrift.protocol.TField RULE_TTL_FIELD_DESC = new org.apache.thrift.protocol.TField("ruleTTL", org.apache.thrift.protocol.TType.I64, (short)7);
  ...
  public int initRedirectMaxCount; // required
  public int sessionRedirectMaxCount; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    INIT_REDIRECT_MAX_COUNT((short)5, "initRedirectMaxCount"),
    SESSION_REDIRECT_MAX_COUNT((short)6, "sessionRedirectMaxCount"),
    RULE_TTL((short)7, "ruleTTL");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // INIT_REDIRECT_MAX_COUNT
          return INIT_REDIRECT_MAX_COUNT;
        case 6: // SESSION_REDIRECT_MAX_COUNT
          return SESSION_REDIRECT_MAX_COUNT;
        case 7: // RULE_TTL
          return RULE_TTL;
        default:
          return null;
  ...
  private static final int __INITREDIRECTMAXCOUNT_ISSET_ID = 4;
  private static final int __SESSIONREDIRECTMAXCOUNT_ISSET_ID = 5;
  private static final int __RULETTL_ISSET_ID = 6;
  ...
  static {
    ...
    tmpMap.put(_Fields.SESSION_REDIRECT_PROBABILITY, new org.apache.thrift.meta_data.FieldMetaData("sessionRedirectProbability", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE        , "probability")));
    tmpMap.put(_Fields.INIT_REDIRECT_MAX_COUNT, new org.apache.thrift.meta_data.FieldMetaData("initRedirectMaxCount", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32        , "Integer")));
    tmpMap.put(_Fields.SESSION_REDIRECT_MAX_COUNT, new org.apache.thrift.meta_data.FieldMetaData("sessionRedirectMaxCount", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32        , "Integer")));
  ...
  public RedirectionRule(
    ...
    int initRedirectMaxCount,
    int sessionRedirectMaxCount,
    long ruleTTL)
  {
    this();
    ...
    this.initRedirectMaxCount = initRedirectMaxCount;
    setInitRedirectMaxCountIsSet(true);
    this.sessionRedirectMaxCount = sessionRedirectMaxCount;
    setSessionRedirectMaxCountIsSet(true);
  ...
  public RedirectionRule(RedirectionRule other) {
    ...
    this.initRedirectMaxCount = other.initRedirectMaxCount;
    this.sessionRedirectMaxCount = other.sessionRedirectMaxCount;
  ...
  public void clear() {
    ...
    setInitRedirectMaxCountIsSet(false);
    this.initRedirectMaxCount = 0;
    setSessionRedirectMaxCountIsSet(false);
    this.sessionRedirectMaxCount = 0;
  ...
  public int getInitRedirectMaxCount() {
    return this.initRedirectMaxCount;
  }

  public RedirectionRule setInitRedirectMaxCount(int initRedirectMaxCount) {
    this.initRedirectMaxCount = initRedirectMaxCount;
    setInitRedirectMaxCountIsSet(true);
    return this;
  }

  public void unsetInitRedirectMaxCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __INITREDIRECTMAXCOUNT_ISSET_ID);
  }

  /** Returns true if field initRedirectMaxCount is set (has been assigned a value) and false otherwise */
  public boolean isSetInitRedirectMaxCount() {
    return EncodingUtils.testBit(__isset_bitfield, __INITREDIRECTMAXCOUNT_ISSET_ID);
  }

  public void setInitRedirectMaxCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __INITREDIRECTMAXCOUNT_ISSET_ID, value);
  }

  public int getSessionRedirectMaxCount() {
    return this.sessionRedirectMaxCount;
  }

  public RedirectionRule setSessionRedirectMaxCount(int sessionRedirectMaxCount) {
    this.sessionRedirectMaxCount = sessionRedirectMaxCount;
    setSessionRedirectMaxCountIsSet(true);
    return this;
  }

  public void unsetSessionRedirectMaxCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SESSIONREDIRECTMAXCOUNT_ISSET_ID);
  }

  /** Returns true if field sessionRedirectMaxCount is set (has been assigned a value) and false otherwise */
  public boolean isSetSessionRedirectMaxCount() {
    return EncodingUtils.testBit(__isset_bitfield, __SESSIONREDIRECTMAXCOUNT_ISSET_ID);
  }

  public void setSessionRedirectMaxCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SESSIONREDIRECTMAXCOUNT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INIT_REDIRECT_MAX_COUNT:
      if (value == null) {
        unsetInitRedirectMaxCount();
      } else {
        setInitRedirectMaxCount((Integer)value);
      }
      break;

    case SESSION_REDIRECT_MAX_COUNT:
      if (value == null) {
        unsetSessionRedirectMaxCount();
      } else {
        setSessionRedirectMaxCount((Integer)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case INIT_REDIRECT_MAX_COUNT:
      return Integer.valueOf(getInitRedirectMaxCount());

    case SESSION_REDIRECT_MAX_COUNT:
      return Integer.valueOf(getSessionRedirectMaxCount());
  ...
  public boolean isSet(_Fields field) {
    ...
    case INIT_REDIRECT_MAX_COUNT:
      return isSetInitRedirectMaxCount();
    case SESSION_REDIRECT_MAX_COUNT:
      return isSetSessionRedirectMaxCount();
    case RULE_TTL:
      return isSetRuleTTL();
    }
    throw new IllegalStateException();
  ...
  public boolean equals(RedirectionRule that) {
    ...
    boolean this_present_initRedirectMaxCount = true;
    boolean that_present_initRedirectMaxCount = true;
    if (this_present_initRedirectMaxCount || that_present_initRedirectMaxCount) {
      if (!(this_present_initRedirectMaxCount && that_present_initRedirectMaxCount))
        return false;
      if (this.initRedirectMaxCount != that.initRedirectMaxCount)
        return false;
    }

    boolean this_present_sessionRedirectMaxCount = true;
    boolean that_present_sessionRedirectMaxCount = true;
    if (this_present_sessionRedirectMaxCount || that_present_sessionRedirectMaxCount) {
      if (!(this_present_sessionRedirectMaxCount && that_present_sessionRedirectMaxCount))
        return false;
      if (this.sessionRedirectMaxCount != that.sessionRedirectMaxCount)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_initRedirectMaxCount = true;
    list.add(present_initRedirectMaxCount);
    if (present_initRedirectMaxCount)
      list.add(initRedirectMaxCount);

    boolean present_sessionRedirectMaxCount = true;
    list.add(present_sessionRedirectMaxCount);
    if (present_sessionRedirectMaxCount)
      list.add(sessionRedirectMaxCount);
  ...
  public int compareTo(RedirectionRule other) {
    ...
    lastComparison = Boolean.valueOf(isSetInitRedirectMaxCount()).compareTo(other.isSetInitRedirectMaxCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInitRedirectMaxCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.initRedirectMaxCount, other.initRedirectMaxCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSessionRedirectMaxCount()).compareTo(other.isSetSessionRedirectMaxCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSessionRedirectMaxCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sessionRedirectMaxCount, other.sessionRedirectMaxCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("initRedirectMaxCount:");
    sb.append(this.initRedirectMaxCount);
    first = false;
    if (!first) sb.append(", ");
    sb.append("sessionRedirectMaxCount:");
    sb.append(this.sessionRedirectMaxCount);
    first = false;
    if (!first) sb.append(", ");
    sb.append("ruleTTL:");
  ...
  private static class RedirectionRuleStandardScheme extends StandardScheme<RedirectionRule> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, RedirectionRule struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // INIT_REDIRECT_MAX_COUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.initRedirectMaxCount = iprot.readI32();
              struct.setInitRedirectMaxCountIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 6: // SESSION_REDIRECT_MAX_COUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.sessionRedirectMaxCount = iprot.readI32();
              struct.setSessionRedirectMaxCountIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RedirectionRule struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(INIT_REDIRECT_MAX_COUNT_FIELD_DESC);
      oprot.writeI32(struct.initRedirectMaxCount);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(SESSION_REDIRECT_MAX_COUNT_FIELD_DESC);
      oprot.writeI32(struct.sessionRedirectMaxCount);
      oprot.writeFieldEnd();
  ...
  private static class RedirectionRuleTupleScheme extends TupleScheme<RedirectionRule> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, RedirectionRule struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetInitRedirectMaxCount()) {
        optionals.set(4);
      }
      if (struct.isSetSessionRedirectMaxCount()) {
        optionals.set(5);
      }
